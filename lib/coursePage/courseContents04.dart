...
import 'package:test_app/courseData/course04.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage04 extends StatefulWidget {
  const CoursePage04({Key? key}) : super(key: key);

  @override
  State<CoursePage04> createState() => _CoursePage04State();
}

class _CoursePage04State extends State<CoursePage04> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('배열', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
