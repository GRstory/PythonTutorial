...
import 'package:test_app/courseData/course09.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage09 extends StatefulWidget {
  const CoursePage09({Key? key}) : super(key: key);

  @override
  State<CoursePage09> createState() => _CoursePage09State();
}

class _CoursePage09State extends State<CoursePage09> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('클래스', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
