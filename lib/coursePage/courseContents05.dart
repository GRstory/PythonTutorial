...
import 'package:test_app/courseData/course05.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage05 extends StatefulWidget {
  const CoursePage05({Key? key}) : super(key: key);

  @override
  State<CoursePage05> createState() => _CoursePage05State();
}

class _CoursePage05State extends State<CoursePage05> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('조건문', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
