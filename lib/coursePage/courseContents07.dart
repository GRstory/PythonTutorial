...
import 'package:test_app/courseData/course07.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage07 extends StatefulWidget {
  const CoursePage07({Key? key}) : super(key: key);

  @override
  State<CoursePage07> createState() => _CoursePage07State();
}

class _CoursePage07State extends State<CoursePage07> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('함수', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
