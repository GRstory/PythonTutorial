...
import 'package:test_app/courseData/course06.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage06 extends StatefulWidget {
  const CoursePage06({Key? key}) : super(key: key);

  @override
  State<CoursePage06> createState() => _CoursePage06State();
}

class _CoursePage06State extends State<CoursePage06> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('반복문', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
