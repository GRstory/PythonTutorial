...
import 'package:test_app/courseData/courseInfo.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePageInfo extends StatefulWidget {
  const CoursePageInfo({Key? key}) : super(key: key);

  @override
  State<CoursePageInfo> createState() => _CoursePageInfoState();
}

class _CoursePageInfoState extends State<CoursePageInfo> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('파이썬 강좌 보는법', style: TextStyle(color: colorShiftText),),
          centerTitle: true,
          elevation: 0.0,
          backgroundColor: colorShift1,
          leading: IconButton(
