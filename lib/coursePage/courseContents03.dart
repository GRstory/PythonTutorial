...
import 'package:test_app/courseData/course03.dart';
import 'package:test_app/theme/themeData.dart';

class CoursePage03 extends StatefulWidget {
  const CoursePage03({Key? key}) : super(key: key);

  @override
  State<CoursePage03> createState() => _CoursePage03State();
}

class _CoursePage03State extends State<CoursePage03> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('연산자', style: TextStyle(color: colorShiftText),),
        centerTitle: true,
        elevation: 0.0,
        backgroundColor: colorShift1,
        leading: IconButton(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  ...
                  onTap: (){
                    Clipboard.setData(ClipboardData(text: code7));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('코드 복사')));
                  },
                ),
                ...
                Text(ex08, style: TextStyle(fontSize: 20, color: colorShiftText),),
                ...
                InkWell(
                  ...
                  onTap: (){
                    Clipboard.setData(ClipboardData(text: code8));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('코드 복사')));
                  },
                ),
                ...
                Text(ex09, style: TextStyle(fontSize: 20, color: colorShiftText),),
                ...
                InkWell(
                  ...
                  onTap: (){
                    Clipboard.setData(ClipboardData(text: code9));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('코드 복사')));
                  },
                ),
                const SizedBox(height: 20,),

                Text(ex10, style: TextStyle(fontSize: 20, color: colorShiftText),),
                ...
                InkWell(
                  ...
                  onTap: (){
                    Clipboard.setData(ClipboardData(text: code10));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('코드 복사')));
                  },
                ),
                ...
                Text(ex11, style: TextStyle(fontSize: 20, color: colorShiftText),),
                ...
                InkWell(
                  ...
                  onTap: (){
                    Clipboard.setData(ClipboardData(text: code11));
                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('코드 복사')));
                  },
                ),
                ...
                Text(ex12, style: TextStyle(fontSize: 20, color: colorShiftText),),
              ],
            ),
          ),
        ),
