...
import 'package:test_app/quizData/quiz02.dart';
import 'package:test_app/theme/themeData.dart';

class QuizPage02 extends StatefulWidget {
  const QuizPage02({Key? key}) : super(key: key);

  @override
  State<QuizPage02> createState() => _QuizPage02State();
}

class _QuizPage02State extends State<QuizPage02> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('if-elif문 활용', style: TextStyle(color: colorShiftText),),
          centerTitle: true,
          elevation: 0.0,
          backgroundColor: colorShift1,
          leading: IconButton(
