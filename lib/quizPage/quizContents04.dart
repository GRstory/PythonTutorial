...
import 'package:test_app/quizData/quiz04.dart';
import 'package:test_app/theme/themeData.dart';

class QuizPage04 extends StatefulWidget {
  const QuizPage04({Key? key}) : super(key: key);

  @override
  State<QuizPage04> createState() => _QuizPage04State();
}

class _QuizPage04State extends State<QuizPage04> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('중복 반복문 활용', style: TextStyle(color: colorShiftText),),
          centerTitle: true,
          elevation: 0.0,
          backgroundColor: colorShift1,
          leading: IconButton(
