...
import 'package:test_app/quizData/quiz03.dart';
import 'package:test_app/theme/themeData.dart';

class QuizPage03 extends StatefulWidget {
  const QuizPage03({Key? key}) : super(key: key);

  @override
  State<QuizPage03> createState() => _QuizPage03State();
}

class _QuizPage03State extends State<QuizPage03> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('반복문 활용', style: TextStyle(color: colorShiftText),),
          centerTitle: true,
          elevation: 0.0,
          backgroundColor: colorShift1,
          leading: IconButton(
