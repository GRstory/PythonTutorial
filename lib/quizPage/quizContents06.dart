...
import 'package:test_app/quizData/quiz06.dart';
import 'package:test_app/theme/themeData.dart';

class QuizPage06 extends StatefulWidget {
  const QuizPage06({Key? key}) : super(key: key);

  @override
  State<QuizPage06> createState() => _QuizPage06State();
}

class _QuizPage06State extends State<QuizPage06> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(
          title: Text('함수 활용', style: TextStyle(color: colorShiftText),),
          centerTitle: true,
          elevation: 0.0,
          backgroundColor: colorShift1,
          leading: IconButton(
